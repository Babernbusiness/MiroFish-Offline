...
class TwitterSimulationRunner:
    ...
    async def run(self, max_rounds: int = None):
        ...
        # Create environment with Platform instance for better post diversity
        # Higher max_rec_post_len and refresh_rec_post_count reduce repetition
        # by giving agents more diverse posts to react to
        ...
        platform = Platform(
            ...
            refresh_rec_post_count=5,  # Increased from 2 for more diverse posts
            max_rec_post_len=10,  # Increased from 2 for larger recommendation buffer
        ...
        if initial_posts:
            ...
            for post in initial_posts:
                ...
                try:
                    ...
                    print(
                        f"  Warning: Unable to create for Agent {agent_id}Create initial posts: {e}"
                    )
